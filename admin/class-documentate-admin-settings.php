...
class Documentate_Admin_Settings {
	...
	public function collabora_base_url_render() {
		...
		echo
			'<input type="url" class="regular-text" name="documentate_settings[collabora_base_url]" value="'
				. esc_attr($value)
	...
	public function collabora_lang_render() {
		...
		echo
			'<input type="text" class="regular-text" name="documentate_settings[collabora_lang]" value="'
				. esc_attr($value)
				. '" placeholder="en-US">'
		;
		echo
	...
	public function collabora_disable_ssl_render() {
		...
		echo '<label>';
		echo
			'<input type="checkbox" name="documentate_settings[collabora_disable_ssl]" value="1" '
	...
	public function collaborative_enabled_render() {
		...
		echo '<label>';
		echo
			'<input type="checkbox" name="documentate_settings[collaborative_enabled]" value="1" '
				. checked($checked, true, false)
				. '> '
		;
	...
	public function collaborative_signaling_render() {
		...
		echo
			'<input type="url" class="regular-text" name="documentate_settings[collaborative_signaling]" value="'
				. esc_attr($value)
